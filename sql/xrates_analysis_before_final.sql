...
from read_csv('..\\data\\staging\\xrates_aud_nzd_20240308_20240407_20240407171859.csv', dateformat = '%Y-%m-%d') Y
join
(SELECT
 BaseCurrency
, TargetCurrency
...
FROM read_csv('..\\data\\staging\\xrates_aud_nzd_20240308_20240407_20240407171859.csv', dateformat = '%Y-%m-%d')
